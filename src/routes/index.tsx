...
function Splash() {
  ...
  return (
    <div className="mx-auto max-w-md min-h-dvh flex flex-col items-center justify-center bg-background px-6 text-center">
      ...
      <p className="mt-2 text-lg font-semibold text-primary">Pay. Easy. Together.</p>
      <p className="mt-8 text-xs text-muted-foreground">For the communities of Sabah & Sarawak</p>
      <Link to="/onboarding" className="mt-6 text-xs text-muted-foreground underline">Skip</Link>
    </div>
  );
}

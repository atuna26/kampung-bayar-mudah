  ...
  return (
    <div className="mx-auto max-w-md min-h-dvh bg-background px-6 pt-10 pb-8 flex flex-col">
      <div className="flex flex-col items-center text-center">
        ...
        <h1 className="mt-3 text-xl font-extrabold">Selamat Kembali</h1>
        <p className="text-sm text-muted-foreground">Masukkan PIN 4 angka anda</p>
      </div>
      ...
      <Link to="/help" className="text-center text-sm text-primary font-semibold mt-6">Lupa PIN? Hubungi ejen</Link>
    </div>
  );
}
